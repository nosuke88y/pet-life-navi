...
A. 基本はサーモン・イワシを主原料としたフードを選び、必要に応じてフィッシュオイルを補うのがおすすめです。主原料が魚のフードなら、毎日の食事で自然にオメガ3（EPA・DHA）を摂取でき、追加のサプリが不要なケースも多いです。一方、現在のフードを変えたくない場合や、より積極的に抗炎症を狙いたい場合はフィッシュオイルを追加する方法もあります。過剰摂取は下痢の原因になるため、獣医師に適量（体重1kgあたりEPA+DHAで約20〜30mg目安）を確認しましょう。
