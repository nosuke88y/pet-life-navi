...
A. 24時間営業のペットショップや動物病院の夜間対応を探すのが最優先です。どうしても入手できない場合の一時代用として、お湯40mlにゆで卵の黄身1/2個・無糖ヨーグルトの上澄み少量を混ぜた液を人肌に温めて与える方法があります。ただし、これは数時間のつなぎで、翌朝には必ず猫専用ミルクに切り替えてください。牛乳・豆乳は絶対に使わないでください。
