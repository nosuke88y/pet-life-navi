...
A. フィッシュオイル由来のEPA・DHAサプリメントは神経の安定に寄与する可能性が示唆されていますが、**適切な投与量は猫の体格・基礎疾患・服薬内容によって大きく異なり、一律の目安量をここで示すことはできません。** 抗てんかん薬との相互作用や、過剰摂取による出血傾向・膵炎リスクもあるため、製品と用量は必ず主治医に相談し、処方された量を守って使用してください。人間用サプリを自己判断で与えるのは避けましょう。
