...
A. フィッシュオイル由来のEPA・DHAサプリメントは神経の安定に寄与する可能性があり、獣医師の承認があれば併用可能です。目安は体重4kgの猫で1日EPA+DHA合計50〜100mg程度ですが、抗てんかん薬との相互作用や出血傾向のリスクもあるため、必ず主治医に使用の可否と量を相談してください。人間用サプリを自己判断で与えるのは避けましょう。

**Q. 発作直後にごはんを食べさせても平気ですか？**

A. 発作直後は意識がぼんやりしていたり、嚥下（えんげ）機能が戻っていなかったりするため、誤嚥の危険があります。完全に意識が戻り、普通に歩けるようになってから（目安は30分〜1時間後）少量ずつ与えましょう。また低血糖が疑われる場合は獣医師の指示のもとブドウ糖を歯茎に塗るなどの応急処置が必要になることもあります。
