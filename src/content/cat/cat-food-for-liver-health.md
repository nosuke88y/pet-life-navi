...
**2日目：受診を検討**
- 1日以上絶食が続いたら動物病院へ電話相談
- 元気・水分摂取・排泄の有無も確認

**3日目以降：必ず受診**
- 連続48時間以上の絶食は脂肪肝リスクが急上昇
- 強制給餌や点滴が必要な場合がある
...
A. 猫のALTの基準値はおおむね20〜100U/L（検査機関により異なります）で、基準上限を軽度でも超えた段階で食事を見直す価値があります。100〜200U/L程度であれば一般フードから肝臓ケアを意識したフードに切り替え、3ヶ月後に再検査という進め方が多いです。200U/L以上や他の項目（ALP・GGT）も上がっている場合は療法食と投薬が必要になるため、必ず獣医師の診察を受けてください。
...
**Q. 市販のサプリ（SAMe・ミルクシスル）は与えても大丈夫ですか？**

A. SAMe（サミー）やシリマリン（ミルクシスル）は肝細胞の保護作用が期待でき、動物病院でも処方される成分です。ただし用量が重要で、体重4kgの猫で1日SAMe 90mg程度が目安とされます。人間用サプリは用量が多すぎることが多いので、必ずペット用製品を獣医師の指示の下で使用してください。自己判断での併用は避けましょう。
