...
A. ステージAや軽度のB1であれば一般的な総合栄養食でも問題ないことが多いですが、ステージB2以降は低ナトリウム設計の心臓病療法食への切り替えが推奨されます。市販フードはナトリウム含有量が0.3〜0.5%前後のものが多く、療法食（0.08〜0.2%程度）と比べると高めです。保証成分値を確認し、獣医師と相談して選びましょう。

**Q. グレインフリーフードは心臓病に悪いと聞きましたが本当ですか？**

A. 米国FDAが2018年以降、グレインフリーフードと拡張型心筋症（DCM）との関連を調査しており、一部の犬で因果関係が示唆されています。豆類やジャガイモを主原料とするフードでタウリン欠乏を引き起こす可能性が指摘されているため、心臓病リスクのある犬種や既に心臓病と診断された犬では長期使用を避け、穀物入りフードを選ぶのが安全です。
