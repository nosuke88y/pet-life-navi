...
A. まず慌てずに、清潔なガーゼやティッシュで出血部分を2〜3分しっかり押さえて圧迫止血します。それで止まらない場合は、ペット用止血剤（クイックストップなど）を爪の断面に軽く押し当てると数十秒で止血できます。自宅に止血剤がない場合の応急処置として、小麦粉やコーンスターチを爪に押しつけて血を固めるという方法もあります。10分以上出血が続く場合や、翌日腫れ・膿が出る場合は動物病院を受診してください。
