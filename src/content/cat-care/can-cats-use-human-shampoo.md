---
title: "猫に人間用シャンプーはNG！pH・成分の違いと安全な猫用シャンプーの選び方"
description: "猫に人間用シャンプーを使うと皮膚トラブルや中毒のリスクがあります。pH値の違い・避けるべき成分・誤って使った場合の対処法、安全な猫用シャンプーの選び方を解説します。"
date: 2026-03-27
...
**Q. 「無添加」「オーガニック」の人間用シャンプーでも、猫に使ってはいけないのはなぜですか？**

A. 「無添加」でも人間の弱酸性皮膚（pH4.5〜6.0）に合わせて作られている点は変わらず、猫の皮膚pHとは異なるため皮膚バリアが乱れます。むしろオーガニック系はティーツリーやラベンダーなどの精油・植物成分を含む製品が多く、猫はこれらを肝臓で代謝できないため、毛づくろいで舐めることで中毒を起こす危険があります。ベビーシャンプーも低刺激設計というだけでpHは人間向けのままです。必ず猫専用シャンプーを使い、精油・ティーツリーオイルが含まれていないか成分表示も確認してください。
